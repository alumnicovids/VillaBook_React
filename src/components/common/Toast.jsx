...
export const Toast = () => {
  ...
  return (
    ...
    >
      <div className={`relative overflow-hidden glass-strong min-w-[320px] max-w-md p-5 rounded-2xl border ${styles.border} shadow-2xl flex items-start gap-4 backdrop-blur-xl`}>
        ...
        <div className="flex-1 pt-1">
          <h4 className={`text-xs font-bold uppercase tracking-widest mb-1 ${styles.accent}`}>
